...
exports.uploadPuzzles = exports.uploadPuzzleBuffer = exports.getPuzzle = exports.getPuzzleMetadata = exports.getAllPuzzlesMetadata = void 0;
...
//     });
// }
function uploadPuzzleBuffer(request, response, next) {
    console.log('loadPuzzle');
    console.log('request.query:');
    console.log(request.query);
    const { puzzleBuffer, sourceFileName } = request.body;
    const pc = PuzCrossword.from(puzzleBuffer);
    console.log(pc);
...
exports.uploadPuzzleBuffer = uploadPuzzleBuffer;
